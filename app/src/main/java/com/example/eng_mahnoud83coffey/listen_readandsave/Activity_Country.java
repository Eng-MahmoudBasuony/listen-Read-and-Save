...
public class Activity_Country extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__country);
        ...
        try {
            ...
            is = this.getAssets().open("country.txt"); // الوصول الى الملف النصي
...
////////////////////////Array Arabic////////////////////
        try {
            ...
            is = this.getAssets().open("السياحه_والدول.txt"); // الوصول الى الملف النصي
            reader = new BufferedReader(new InputStreamReader(is, "UTF8")); // قارئ بفرد وهو يستخدم عادة لقراءة الملفات الضخمة, وسوف يقرأ من الملف النصي
        ...
        AllRecyclerviewAdabter adabter=new AllRecyclerviewAdabter(all_text,Activity_Country.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.Back_MainActivity:
                Intent intent=new Intent(Activity_Country.this,MainActivity.class);
