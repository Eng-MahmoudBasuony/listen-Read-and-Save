...
public class Activity_Clothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__clothes);

        StartAppSDK.init(this, "202852472", true);


        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recyclerview_Clothes);
        ...
        try {
            ...
            is = this.getAssets().open("clothes.txt"); // الوصول الى الملف النصي
...
////////////////////////Array Arabic////////////////////
        try {
            ...
            is = this.getAssets().open("الملابس.txt"); // الوصول الى الملف النصي
            reader = new BufferedReader(new InputStreamReader(is, "UTF8")); // قارئ بفرد وهو يستخدم عادة لقراءة الملفات الضخمة, وسوف يقرأ من الملف النصي
        ...
        AllRecyclerviewAdabter adabter=new AllRecyclerviewAdabter(all_text,Activity_Clothes.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.Back_MainActivity:
                Intent intent=new Intent(Activity_Clothes.this,MainActivity.class);
