...
public class Activity_PubularWards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__pubular_wards);

        StartAppSDK.init(this, "202852472", true);

        recyclerView=(RecyclerView)findViewById(R.id.recyclerviewPubularWards);
        ...
        try {
            ...
            is = this.getAssets().open("pupularwords.txt"); // الوصول الى الملف النصي
...
////////////////////////Array Arabic////////////////////
        try {
            ...
            is = this.getAssets().open("الكلمات_الشائعه.txt"); // الوصول الى الملف النصي
            reader = new BufferedReader(new InputStreamReader(is, "UTF8")); // قارئ بفرد وهو يستخدم عادة لقراءة الملفات الضخمة, وسوف يقرأ من الملف النصي
        ...
        AllRecyclerviewAdabter adabter=new AllRecyclerviewAdabter(all_text,Activity_PubularWards.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.Back_MainActivity:
                Intent intent=new Intent(Activity_PubularWards.this,MainActivity.class);
