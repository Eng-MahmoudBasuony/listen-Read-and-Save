...
public class Activity_Education extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__education);

        StartAppSDK.init(this, "202852472", true);



        RecyclerView recyclerView=(RecyclerView)findViewById(R.id.recyclerviewEductation);
        ...
        try {
            ...
            is = this.getAssets().open("education.txt"); // الوصول الى الملف النصي
...
////////////////////////Array Arabic////////////////////
        try {
            ...
            is = this.getAssets().open("مقتطفات من القاموس التعليمي.txt"); // الوصول الى الملف النصي
            reader = new BufferedReader(new InputStreamReader(is, "UTF8")); // قارئ بفرد وهو يستخدم عادة لقراءة الملفات الضخمة, وسوف يقرأ من الملف النصي
        ...
        AllRecyclerviewAdabter adabter=new AllRecyclerviewAdabter(all_text,Activity_Education.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.Back_MainActivity:
                Intent intent=new Intent(Activity_Education.this,MainActivity.class);
