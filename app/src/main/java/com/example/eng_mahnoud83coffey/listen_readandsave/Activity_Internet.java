...
public class Activity_Internet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__internet);

        StartAppSDK.init(this, "202852472", true);

        recyclerView=(RecyclerView)findViewById(R.id.recyclerviewInternet);
        ...
        try {
            ...
            is = this.getAssets().open("Internet_combuter.txt"); // الوصول الى الملف النصي
...
////////////////////////Array Arabic////////////////////
        try {
            ...
            is = this.getAssets().open("الشبكه_والحاسب.txt"); // الوصول الى الملف النصي
            reader = new BufferedReader(new InputStreamReader(is, "UTF8")); // قارئ بفرد وهو يستخدم عادة لقراءة الملفات الضخمة, وسوف يقرأ من الملف النصي
        ...
        AllRecyclerviewAdabter adabter=new AllRecyclerviewAdabter(all_text,Activity_Internet.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.Back_MainActivity:
                Intent intent=new Intent(Activity_Internet.this,MainActivity.class);
